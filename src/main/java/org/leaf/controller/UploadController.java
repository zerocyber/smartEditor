...
import org.leaf.domain.PhotoVO;
...
public class UploadController {
	...
	@RequestMapping(value="/upload/photoUpload", method=RequestMethod.POST)
	public String photoUpload(HttpServletRequest req, PhotoVO vo ) {
